...
//             <div className="min-h-[93vh] w-full overflow-hidden flex flex-col justify-between font-sans relative bg-white">
//                 <div className="absolute inset-0 z-0 bg-gradient-to-b from-[#fff9f5] to-[#FFE8DD]"></div>

//                 {/* Main Content */}
//                 {/* <div className="flex-grow flex flex-col mt-36 justify-center items-center text-center relative z-10 px-4"> */}
